...
@section('body')
    <div
        class="items-top bg-gray-100 dark:bg-gray-900 relative flex min-h-screen justify-center py-4 sm:items-center sm:pt-0">
        @if (Route::has('login'))
            <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/home') }}" class="text-gray-700 dark:text-gray-500 text-sm underline">Home</a>
                @else
                    <a href="{{ route('login') }}" class="text-gray-700 dark:text-gray-500 text-sm underline">Log in</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="text-gray-700 dark:text-gray-500 ml-4 text-sm underline">Register</a>
                    @endif
                @endauth
            </div>
        @endif

        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8" data-behavior="dummy">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="text-gray-700 h-16 w-auto sm:h-20">
            ...
            <div class="bg-white dark:bg-gray-800 mt-8 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="text-gray-500 h-8 w-8">
                                <path
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7"><a href="https://laravel.com/docs"
                                    class="text-gray-900 dark:text-white underline">Documentation</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="text-gray-600 dark:text-gray-400 mt-2 text-sm">
                    ...
                    <div class="border-gray-200 dark:border-gray-700 border-t p-6 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="text-gray-500 h-8 w-8">
                                <path
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7"><a href="https://laracasts.com"
                                    class="text-gray-900 dark:text-white underline">Laracasts</a>
                            </div>
                        </div>
                    ...
                    <div class="border-gray-200 dark:border-gray-700 border-t p-6">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="text-gray-500 h-8 w-8">
                                <path
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7"><a href="https://laravel-news.com/"
                                    class="text-gray-900 dark:text-white underline">Laravel
                                    News</a></div>
                        </div>
                    ...
                    <div class="border-gray-200 dark:border-gray-700 border-t p-6 md:border-l">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="text-gray-500 h-8 w-8">
                                <path
                            ...
                            <div class="text-gray-900 dark:text-white ml-4 text-lg font-semibold leading-7">Vibrant
                                Ecosystem
                            </div>
                        </div>
            ...
            <div class="mt-4 flex justify-center sm:items-center sm:justify-between">
                <div class="text-gray-500 text-center text-sm sm:text-left">
                    <div class="flex items-center">
                        <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            viewBox="0 0 24 24" stroke="currentColor" class="-mt-px text-gray-400 h-5 w-5">
                            <path
                        ...
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" class="-mt-px text-gray-400 ml-4 h-5 w-5">
                            <path
                ...
                <div class="text-gray-500 ml-4 text-center text-sm sm:ml-0 sm:text-right">
